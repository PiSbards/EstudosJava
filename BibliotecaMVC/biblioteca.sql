...
CREATE TABLE `emprestimo` (
  ...
  CONSTRAINT `emprestimo_ibfk_1` FOREIGN KEY (`id_cliente`) REFERENCES `cliente` (`id_cliente`),
...
CREATE TABLE `multa` (
  ...
  KEY `id_cliente` (`id_cliente`),
  CONSTRAINT `multa_ibfk_1` FOREIGN KEY (`id_cliente`) REFERENCES `cliente` (`id_cliente`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-09-14 21:25:16
